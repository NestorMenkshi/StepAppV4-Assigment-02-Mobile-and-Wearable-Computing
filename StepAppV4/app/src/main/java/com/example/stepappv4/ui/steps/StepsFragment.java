        ...
        materialButtonToggleGroup.addOnButtonCheckedListener(new MaterialButtonToggleGroup.OnButtonCheckedListener() {
            ...
            public void onButtonChecked(MaterialButtonToggleGroup group, int checkedId, boolean isChecked) {
                ...
                if (checkedId == R.id.toggleStart_btn) {
                    ...
                    // TODO 6: Check if ACC. sensor exists and register the sensor event listener to it when user presses start button
                    if (accSensor != null) {
                        // Pass the progress bar to the constructor of the listener class
